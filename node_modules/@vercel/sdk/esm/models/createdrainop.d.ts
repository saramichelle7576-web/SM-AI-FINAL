...
export declare const ResponseBodyCreatedFrom: {
    readonly SelfServed: "self-served";
    readonly Integration: "integration";
};
export type ResponseBodyCreatedFrom = ClosedEnum<typeof ResponseBodyCreatedFrom>;
...
export declare const CreateDrainResponseBodyFramework: {
...
export type CreateDrainResponseBodyFramework = ClosedEnum<typeof CreateDrainResponseBodyFramework>;
...
export type CreateDrainResponseBody2 = {
    ...
    delivery?: CreateDrainDeliveryDrains1 | CreateDrainDeliveryDrains2 | CreateDrainDelivery3 | CreateDrainDelivery4 | undefined;
...
export declare const CreateDrainResponseBodyCreatedFrom: {
    readonly SelfServed: "self-served";
    readonly Integration: "integration";
};
export type CreateDrainResponseBodyCreatedFrom = ClosedEnum<typeof CreateDrainResponseBodyCreatedFrom>;
...
export declare const ResponseBodyEnv: {
    readonly Production: "production";
    readonly Preview: "preview";
};
...
export type CreateDrainResponseBody1 = {
    ...
    delivery?: CreateDrainDelivery1 | CreateDrainDelivery2 | Delivery3 | Delivery4 | undefined;
...
/** @internal */
export type CreateDrainSource$Outbound = One1$Outbound | One2$Outbound | One3$Outbound | Source2$Outbound;
/** @internal */
...
export type CreateDrainRequestBody$Outbound = {
    ...
    source?: One1$Outbound | One2$Outbound | One3$Outbound | Source2$Outbound | undefined;
};
/** @internal */
...
/** @internal */
export declare const ResponseBodyCreatedFrom$inboundSchema: z.ZodNativeEnum<typeof ResponseBodyCreatedFrom>;
/** @internal */
export declare const ResponseBodyCreatedFrom$outboundSchema: z.ZodNativeEnum<typeof ResponseBodyCreatedFrom>;
/** @internal */
...
/** @internal */
export declare const CreateDrainResponseBodyFramework$inboundSchema: z.ZodNativeEnum<typeof CreateDrainResponseBodyFramework>;
/** @internal */
export declare const CreateDrainResponseBodyFramework$outboundSchema: z.ZodNativeEnum<typeof CreateDrainResponseBodyFramework>;
/** @internal */
export declare const CreateDrainResponseBodyProjectsMetadata$inboundSchema: z.ZodType<CreateDrainResponseBodyProjectsMetadata, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const CreateDrainResponseBodyProjectsMetadata$outboundSchema: z.ZodType<CreateDrainResponseBodyProjectsMetadata$Outbound, z.ZodTypeDef, CreateDrainResponseBodyProjectsMetadata>;
export declare function createDrainResponseBodyProjectsMetadataToJSON(createDrainResponseBodyProjectsMetadata: CreateDrainResponseBodyProjectsMetadata): string;
export declare function createDrainResponseBodyProjectsMetadataFromJSON(jsonString: string): SafeParseResult<CreateDrainResponseBodyProjectsMetadata, SDKValidationError>;
/** @internal */
...
export type CreateDrainResponseBody2$Outbound = {
    ...
    delivery?: CreateDrainDeliveryDrains1$Outbound | CreateDrainDeliveryDrains2$Outbound | CreateDrainDelivery3$Outbound | CreateDrainDelivery4$Outbound | undefined;
    ...
    integrationConfigurationUri?: string | undefined;
    integrationWebsite?: string | undefined;
    projectsMetadata?: Array<CreateDrainResponseBodyProjectsMetadata$Outbound> | undefined;
};
/** @internal */
...
/** @internal */
export declare const CreateDrainResponseBodyCreatedFrom$inboundSchema: z.ZodNativeEnum<typeof CreateDrainResponseBodyCreatedFrom>;
/** @internal */
export declare const CreateDrainResponseBodyCreatedFrom$outboundSchema: z.ZodNativeEnum<typeof CreateDrainResponseBodyCreatedFrom>;
/** @internal */
...
/** @internal */
export declare const ResponseBodyEnv$inboundSchema: z.ZodNativeEnum<typeof ResponseBodyEnv>;
/** @internal */
export declare const ResponseBodyEnv$outboundSchema: z.ZodNativeEnum<typeof ResponseBodyEnv>;
/** @internal */
...
export type CreateDrainResponseBody1$Outbound = {
    ...
    delivery?: CreateDrainDelivery1$Outbound | CreateDrainDelivery2$Outbound | Delivery3$Outbound | Delivery4$Outbound | undefined;
