...
export declare const GetConfigurationTransferRequestKind: {
    readonly TransferFromMarketplace: "transfer-from-marketplace";
};
export type GetConfigurationTransferRequestKind = ClosedEnum<typeof GetConfigurationTransferRequestKind>;
...
/** @internal */
export declare const GetConfigurationTransferRequestKind$inboundSchema: z.ZodNativeEnum<typeof GetConfigurationTransferRequestKind>;
/** @internal */
export declare const GetConfigurationTransferRequestKind$outboundSchema: z.ZodNativeEnum<typeof GetConfigurationTransferRequestKind>;
/** @internal */
