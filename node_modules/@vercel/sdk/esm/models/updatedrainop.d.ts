...
export declare const UpdateDrainResponseBodyDrainsCreatedFrom: {
    readonly SelfServed: "self-served";
    readonly Integration: "integration";
};
export type UpdateDrainResponseBodyDrainsCreatedFrom = ClosedEnum<typeof UpdateDrainResponseBodyDrainsCreatedFrom>;
...
export declare const UpdateDrainResponseBodyFramework: {
...
export type UpdateDrainResponseBodyFramework = ClosedEnum<typeof UpdateDrainResponseBodyFramework>;
...
export type UpdateDrainResponseBody2 = {
    ...
    delivery?: UpdateDrainDeliveryDrainsResponse1 | UpdateDrainDeliveryDrainsResponse2 | UpdateDrainDeliveryDrains3 | UpdateDrainDeliveryDrains4 | undefined;
...
export declare const UpdateDrainResponseBodyCreatedFrom: {
    readonly SelfServed: "self-served";
    readonly Integration: "integration";
};
export type UpdateDrainResponseBodyCreatedFrom = ClosedEnum<typeof UpdateDrainResponseBodyCreatedFrom>;
...
export type UpdateDrainResponseBody1 = {
    ...
    delivery?: UpdateDrainDeliveryDrains1 | UpdateDrainDeliveryDrains2 | UpdateDrainDelivery3 | UpdateDrainDelivery4 | undefined;
...
/** @internal */
export declare const UpdateDrainResponseBodyDrainsCreatedFrom$inboundSchema: z.ZodNativeEnum<typeof UpdateDrainResponseBodyDrainsCreatedFrom>;
/** @internal */
export declare const UpdateDrainResponseBodyDrainsCreatedFrom$outboundSchema: z.ZodNativeEnum<typeof UpdateDrainResponseBodyDrainsCreatedFrom>;
/** @internal */
...
/** @internal */
export declare const UpdateDrainResponseBodyFramework$inboundSchema: z.ZodNativeEnum<typeof UpdateDrainResponseBodyFramework>;
/** @internal */
export declare const UpdateDrainResponseBodyFramework$outboundSchema: z.ZodNativeEnum<typeof UpdateDrainResponseBodyFramework>;
/** @internal */
export declare const UpdateDrainResponseBodyProjectsMetadata$inboundSchema: z.ZodType<UpdateDrainResponseBodyProjectsMetadata, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const UpdateDrainResponseBodyProjectsMetadata$outboundSchema: z.ZodType<UpdateDrainResponseBodyProjectsMetadata$Outbound, z.ZodTypeDef, UpdateDrainResponseBodyProjectsMetadata>;
export declare function updateDrainResponseBodyProjectsMetadataToJSON(updateDrainResponseBodyProjectsMetadata: UpdateDrainResponseBodyProjectsMetadata): string;
export declare function updateDrainResponseBodyProjectsMetadataFromJSON(jsonString: string): SafeParseResult<UpdateDrainResponseBodyProjectsMetadata, SDKValidationError>;
/** @internal */
...
export type UpdateDrainResponseBody2$Outbound = {
    ...
    integrationConfigurationUri?: string | undefined;
    integrationWebsite?: string | undefined;
    projectsMetadata?: Array<UpdateDrainResponseBodyProjectsMetadata$Outbound> | undefined;
};
/** @internal */
...
/** @internal */
export declare const UpdateDrainResponseBodyCreatedFrom$inboundSchema: z.ZodNativeEnum<typeof UpdateDrainResponseBodyCreatedFrom>;
/** @internal */
export declare const UpdateDrainResponseBodyCreatedFrom$outboundSchema: z.ZodNativeEnum<typeof UpdateDrainResponseBodyCreatedFrom>;
/** @internal */
...
export type UpdateDrainResponseBody1$Outbound = {
    ...
    delivery?: UpdateDrainDeliveryDrains1$Outbound | UpdateDrainDeliveryDrains2$Outbound | UpdateDrainDelivery3$Outbound | UpdateDrainDelivery4$Outbound | undefined;
