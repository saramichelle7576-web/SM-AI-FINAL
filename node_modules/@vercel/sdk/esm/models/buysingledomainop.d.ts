 ...
 */
export type BuySingleDomainDomainsRegistrarResponseResponseBody = NotAuthorizedForScope | Forbidden;
/**
 * There was something wrong with the request
 */
export type BuySingleDomainDomainsRegistrarResponseBody = DomainTooShort | OrderTooExpensive | InvalidAdditionalContactInfo | AdditionalContactInfoRequired | ExpectedPriceMismatch | DomainNotAvailable | TldNotSupported | HttpApiDecodeError;
...
/** @internal */
export type BuySingleDomainDomainsRegistrarResponseResponseBody$Outbound = NotAuthorizedForScope$Outbound | Forbidden$Outbound;
/** @internal */
