...
export const tool$projectsGetProjectClientCerts = {
...
Retrieve client certificates configured for a project's mTLS egress authentication.`,
    ...
    tool: async (client, args, ctx) => {
        const [result, apiCall] = await projectsGetProjectClientCerts(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
