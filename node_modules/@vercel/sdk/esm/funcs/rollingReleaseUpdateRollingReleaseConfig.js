...
import { UpdateRollingReleaseConfigRequest$outboundSchema, UpdateRollingReleaseConfigResponseBody$inboundSchema, } from "../models/updaterollingreleaseconfigop.js";
 ...
 */
export function rollingReleaseUpdateRollingReleaseConfig(client, request, options) {
...
async function $do(client, request, options) {
    ...
    const path = pathToFunc("/v1/projects/{idOrName}/rolling-release/config")(pathParams);
    ...
    const [result] = await M.match(M.json(200, UpdateRollingReleaseConfigResponseBody$inboundSchema), M.fail([400, 401, 403, 404, "4XX"]), M.fail("5XX"))(response, req);
    if (!result.ok) {
