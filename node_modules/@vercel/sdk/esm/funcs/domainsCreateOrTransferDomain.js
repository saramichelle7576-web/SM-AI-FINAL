...
import { CreateOrTransferDomainRequest$outboundSchema, CreateOrTransferDomainResponseBody$inboundSchema, } from "../models/createortransferdomainop.js";
 ...
 */
export function domainsCreateOrTransferDomain(client, request, options) {
...
async function $do(client, request, options) {
    ...
    const [result] = await M.match(M.json(200, CreateOrTransferDomainResponseBody$inboundSchema), M.fail([400, 401, 402, 403, 404, 409, "4XX"]), M.fail([500, "5XX"]))(response, req);
    if (!result.ok) {
        return [result, { status: "complete", request: req, response }];
    }
    return [result, { status: "complete", request: req, response }];
}
//# sourceMappingURL=domainsCreateOrTransferDomain.js.map