...
import { CreateIntegrationStoreDirectRequest$outboundSchema, CreateIntegrationStoreDirectResponseBody$inboundSchema, } from "../models/createintegrationstoredirectop.js";
 ...
 */
export function integrationsCreateIntegrationStoreDirect(client, request, options) {
...
async function $do(client, request, options) {
    ...
    const [result] = await M.match(M.json(200, CreateIntegrationStoreDirectResponseBody$inboundSchema), M.fail([400, 401, 402, 403, 404, 409, 429, "4XX"]), M.fail([500, "5XX"]))(response, req);
    if (!result.ok) {
