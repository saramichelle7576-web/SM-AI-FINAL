 ...
 */
export declare function marketplaceUpdateResourceSecrets(client: VercelCore, request: UpdateResourceSecretsRequest, options?: RequestOptions): APIPromise<Result<void, VercelError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
//# sourceMappingURL=marketplaceUpdateResourceSecrets.d.ts.map