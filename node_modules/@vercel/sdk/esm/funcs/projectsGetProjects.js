...
import { GetProjectsRequest$outboundSchema, GetProjectsResponseBody$inboundSchema, } from "../models/getprojectsop.js";
 ...
 */
export function projectsGetProjects(client, request, options) {
...
async function $do(client, request, options) {
    ...
    const [result] = await M.match(M.json(200, GetProjectsResponseBody$inboundSchema), M.fail([400, 401, 403, "4XX"]), M.fail("5XX"))(response, req);
    if (!result.ok) {
        return [result, { status: "complete", request: req, response }];
    }
    return [result, { status: "complete", request: req, response }];
}
//# sourceMappingURL=projectsGetProjects.js.map