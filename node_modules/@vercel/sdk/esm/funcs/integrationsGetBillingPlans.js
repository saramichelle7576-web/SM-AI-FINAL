...
import { GetBillingPlansRequest$outboundSchema, GetBillingPlansResponseBody$inboundSchema, } from "../models/getbillingplansop.js";
 ...
 */
export function integrationsGetBillingPlans(client, request, options) {
...
async function $do(client, request, options) {
    ...
    const [result] = await M.match(M.json(200, GetBillingPlansResponseBody$inboundSchema), M.fail([400, 401, 403, 404, "4XX"]), M.fail("5XX"))(response, req);
    if (!result.ok) {
        return [result, { status: "complete", request: req, response }];
    }
    return [result, { status: "complete", request: req, response }];
}
//# sourceMappingURL=integrationsGetBillingPlans.js.map