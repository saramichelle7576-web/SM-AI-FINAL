...
import { GetDomainTransferRequest$outboundSchema, GetDomainTransferResponseBody$inboundSchema, } from "../models/getdomaintransferop.js";
 ...
 */
export function domainsGetDomainTransfer(client, request, options) {
...
async function $do(client, request, options) {
    ...
    const [result] = await M.match(M.json(200, GetDomainTransferResponseBody$inboundSchema), M.fail([400, 401, 403, "4XX"]), M.fail([500, "5XX"]))(response, req);
    if (!result.ok) {
        return [result, { status: "complete", request: req, response }];
    }
    return [result, { status: "complete", request: req, response }];
}
//# sourceMappingURL=domainsGetDomainTransfer.js.map