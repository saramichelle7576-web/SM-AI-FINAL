...
import { ImportResourceRequest$outboundSchema, ImportResourceResponseBody$inboundSchema, } from "../models/importresourceop.js";
 ...
 */
export function marketplaceImportResource(client, request, options) {
...
async function $do(client, request, options) {
    ...
    const [result] = await M.match(M.json(200, ImportResourceResponseBody$inboundSchema), M.fail([400, 401, 403, 404, 409, 422, "4XX"]), M.fail("5XX"))(response, req);
    if (!result.ok) {
        return [result, { status: "complete", request: req, response }];
    }
    return [result, { status: "complete", request: req, response }];
}
//# sourceMappingURL=marketplaceImportResource.js.map