...
export class Integrations extends ClientSDK {
     ...
     */
    async getBillingPlans(request, options) {
        return unwrapAsync(integrationsGetBillingPlans(this, request, options));
    }
    /**
     ...
     */
    async connectIntegrationResourceToProject(request, options) {
        return unwrapAsync(integrationsConnectIntegrationResourceToProject(this, request, options));
    }
    /**
     ...
     */
    async getConfigurations(request, options) {
        return unwrapAsync(integrationsGetConfigurations(this, request, options));
    }
    /**
     ...
     */
    async getConfiguration(request, options) {
        return unwrapAsync(integrationsGetConfiguration(this, request, options));
    }
    /**
     ...
     */
    async createIntegrationStoreDirect(request, options) {
        return unwrapAsync(integrationsCreateIntegrationStoreDirect(this, request, options));
    }
}
