...
export class Marketplace extends ClientSDK {
     ...
     */
    async updateInstallation(request, options) {
        return unwrapAsync(marketplaceUpdateInstallation(this, request, options));
    }
    /**
     ...
     */
    async getAccountInfo(request, options) {
        return unwrapAsync(marketplaceGetAccountInfo(this, request, options));
    }
    /**
    ...
    async getMember(request, options) {
        return unwrapAsync(marketplaceGetMember(this, request, options));
    }
    /**
     * Create Event
     *
     ...
     */
    async getIntegrationResources(request, options) {
        return unwrapAsync(marketplaceGetIntegrationResources(this, request, options));
    }
    /**
     ...
     */
    async getIntegrationResource(request, options) {
        return unwrapAsync(marketplaceGetIntegrationResource(this, request, options));
    }
    /**
     ...
     */
    async deleteIntegrationResource(request, options) {
        return unwrapAsync(marketplaceDeleteIntegrationResource(this, request, options));
    }
    /**
     * Import Resource
     *
     ...
     */
    async updateResource(request, options) {
        return unwrapAsync(marketplaceUpdateResource(this, request, options));
    }
    /**
     * Submit Billing Data
     *
     ...
     */
    async submitBillingData(request, options) {
        return unwrapAsync(marketplaceSubmitBillingData(this, request, options));
    }
    /**
     * Submit Invoice
     *
     ...
     */
    async submitInvoice(request, options) {
        return unwrapAsync(marketplaceSubmitInvoice(this, request, options));
    }
    /**
     * Get Invoice
     *
    ...
    async getInvoice(request, options) {
        return unwrapAsync(marketplaceGetInvoice(this, request, options));
    }
    /**
     * Invoice Actions
     *
    ...
    async updateInvoice(request, options) {
        return unwrapAsync(marketplaceUpdateInvoice(this, request, options));
    }
    /**
     ...
     */
    async submitPrepaymentBalances(request, options) {
        return unwrapAsync(marketplaceSubmitPrepaymentBalances(this, request, options));
    }
    /**
     ...
     */
    async updateResourceSecrets(request, options) {
        return unwrapAsync(marketplaceUpdateResourceSecrets(this, request, options));
    }
    /**
