...
export class Projects extends ClientSDK {
     ...
     */
    async updateProjectDataCache(request, options) {
        return unwrapAsync(projectsUpdateProjectDataCache(this, request, options));
    }
    /**
     ...
     */
    async getProjectClientCerts(request, options) {
        return unwrapAsync(projectsGetProjectClientCerts(this, request, options));
    }
    /**
     ...
     */
    async deleteProjectClientCert(request, options) {
        return unwrapAsync(projectsDeleteProjectClientCert(this, request, options));
    }
    /**
