...
export class DomainsRegistrar extends ClientSDK {
     ...
     */
    async getSupportedTlds(request, options) {
        return unwrapAsync(domainsRegistrarGetSupportedTlds(this, request, options));
    }
    /**
     * Get TLD price data
     *
     ...
     */
    async getDomainPrice(request, options) {
        return unwrapAsync(domainsRegistrarGetDomainPrice(this, request, options));
    }
    /**
     ...
     * Buy a domain
     */
    async buySingleDomain(request, options) {
     ...
     * Renew a domain
     */
    async renewDomain(request, options) {
...
//# sourceMappingURL=domainsregistrar.js.map