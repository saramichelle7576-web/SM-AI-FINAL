...
test("Marketplace Post /V1 /Installations/{integration Configuration Id}/resources/{resource Id}/experimentation/items", async () => {
    const testHttpClient = createTestHTTPClient("post_/v1/installations/{integrationConfigurationId}/resources/{resourceId}/experimentation/items");
    const vercel = new Vercel({
        serverURL: process.env["TEST_SERVER_URL"] ?? "http://localhost:18080",
        httpClient: testHttpClient,
        bearerToken: "<YOUR_BEARER_TOKEN_HERE>",
...
test("Marketplace Patch /V1 /Installations/{integration Configuration Id}/resources/{resource Id}/experimentation/items/{item Id}", async () => {
    const testHttpClient = createTestHTTPClient("patch_/v1/installations/{integrationConfigurationId}/resources/{resourceId}/experimentation/items/{itemId}");
    const vercel = new Vercel({
        serverURL: process.env["TEST_SERVER_URL"] ?? "http://localhost:18080",
        httpClient: testHttpClient,
        bearerToken: "<YOUR_BEARER_TOKEN_HERE>",
...
test("Marketplace Delete /V1 /Installations/{integration Configuration Id}/resources/{resource Id}/experimentation/items/{item Id}", async () => {
    const testHttpClient = createTestHTTPClient("delete_/v1/installations/{integrationConfigurationId}/resources/{resourceId}/experimentation/items/{itemId}");
    const vercel = new Vercel({
        serverURL: process.env["TEST_SERVER_URL"] ?? "http://localhost:18080",
        httpClient: testHttpClient,
        bearerToken: "<YOUR_BEARER_TOKEN_HERE>",
...
test("Marketplace Put /V1 /Installations/{integration Configuration Id}/resources/{resource Id}/experimentation/edge Config", async () => {
    const testHttpClient = createTestHTTPClient("put_/v1/installations/{integrationConfigurationId}/resources/{resourceId}/experimentation/edge-config");
    const vercel = new Vercel({
        serverURL: process.env["TEST_SERVER_URL"] ?? "http://localhost:18080",
        httpClient: testHttpClient,
        bearerToken: "<YOUR_BEARER_TOKEN_HERE>",
...
it.skip("Marketplace Get Resources", async () => {
    assert.fail("incomplete test found please make sure to address the following errors: [`workflow step get-resources.test referencing operation get-resources not found in document`]");
});
it.skip("Marketplace Get Resource", async () => {
    assert.fail("incomplete test found please make sure to address the following errors: [`workflow step get-resource.test referencing operation get-resource not found in document`]");
});
it.skip("Marketplace Delete Resource", async () => {
    assert.fail("incomplete test found please make sure to address the following errors: [`workflow step delete-resource.test referencing operation delete-resource not found in document`]");
});
